...
import DemoCinema from '@/components/demo/DemoCinema';
import DemoCta from '@/components/DemoCta';

export const metadata: Metadata = {
  title: 'PAWai — Interactive Demo',
  description:
    'See how PAWai reads urgency, history, and evidence — then packs a clinic-ready record. Three rotating care stories: Luna, Milo, and Max.',
      ...
      <section className="hero" aria-labelledby="demo-hero-h1" style={{ paddingBottom: 56 }}>
        <div className="wrap" style={{ textAlign: 'center', maxWidth: 760, margin: '0 auto' }}>
          ...
          <h1 id="demo-hero-h1" data-r data-d="1" style={{ fontSize: 'clamp(2.2rem,4.5vw,3.6rem)' }}>
            See how PAWai reads urgency, history, and evidence
          </h1>
          <p className="hero__lead" data-r data-d="2" style={{ margin: '0 auto' }}>
            See how PAWai reads urgency, history, and evidence — then packs a clinic-ready record.
            Three rotating stories. Educational only; never diagnoses or prescribes.
          </p>
        </div>
      </section>

      <section className="sec" aria-label="PAWai cinema demo" style={{ paddingTop: 0 }}>
        <div className="wrap">
          <DemoCinema />
        </div>
      </section>
      ...
      <section className="sec how" aria-labelledby="demo-feat-h2">
        <div className="wrap">
          <div className="sec__hd">
            <h2 id="demo-feat-h2" data-r>
              Built to make every intake count.
            </h2>
          </div>
          <div className="feats">
            <div className="feat" data-tilt data-r>
              <div className="cg" aria-hidden="true" />
              <div className="ic" style={{ background: 'rgba(var(--teal-rgb),.1)' }} aria-hidden="true">
                🩺
              </div>
              <h3>Asks like a real vet nurse</h3>
              <p>
                Each next question depends on the last answer — different complaints lead down
                entirely different interview paths.
              </p>
            </div>
            <div className="feat" data-tilt data-r data-d="1">
              <div className="cg" aria-hidden="true" />
              <div className="ic" style={{ background: 'rgba(var(--peach-rgb),.11)' }} aria-hidden="true">
                🚨
              </div>
              <h3>Flags urgency signals</h3>
              <p>
                PAWai watches for red flags as the conversation unfolds and updates priority as it
                learns more.
              </p>
            </div>
            <div className="feat" data-tilt data-r data-d="2">
              ...
              <div
                className="ic"
                style={{ background: 'rgba(180,100,160,.12)' }}
                aria-hidden="true"
              >
                📋
              </div>
